...
var MfeOne = /** @class */ (function (_super) {
    ...
    MfeOne.prototype.render = function () {
        if (Object.keys(this.settings).length === 0)
            return html(templateObject_1 || (templateObject_1 = __makeTemplateObject([" <div>Loading settings...</div> "], [" <div>Loading settings...</div> "])));
        return this.settingsMode
            ? html(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n          <div\n            class=\"container\"\n            style=\"background-color: ", "\"\n          >\n            <h2>", "</h2>\n            <div>\n              <label>Background colour</label>\n              <input type=\"text\" @input=\"", "\" />\n            </div>\n            <p><button @click=", ">Done</button></p>\n          </div>\n        "], ["\n          <div\n            class=\"container\"\n            style=\"background-color: ", "\"\n          >\n            <h2>", "</h2>\n            <div>\n              <label>Background colour</label>\n              <input type=\"text\" @input=\"", "\" />\n            </div>\n            <p><button @click=", ">Done</button></p>\n          </div>\n        "])), this.settings.bgColor, this.title, this.__setBgColor, this.__saveSettings) : html(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n          <div\n            class=\"container\"\n            style=\"background-color: ", "\"\n          >\n            <h2>", "</h2>\n            <p>count: ", "</p>\n            <p><button @click=", ">Increment</button></p>\n            <p><button @click=", ">Settings</button></p>\n          </div>\n        "], ["\n          <div\n            class=\"container\"\n            style=\"background-color: ", "\"\n          >\n            <h2>", "</h2>\n            <p>count: ", "</p>\n            <p><button @click=", ">Increment</button></p>\n            <p><button @click=", ">Settings</button></p>\n          </div>\n        "])), this.settings.bgColor, this.title, this.counter, this.__increment, this.__showSettings);
    };
    MfeOne.styles = css(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n    :host {\n      display: block;\n      font-family: sans-serif;\n    }\n    .container {\n      padding: 25px;\n      border: 1px solid cyan;\n    }\n  "], ["\n    :host {\n      display: block;\n      font-family: sans-serif;\n    }\n    .container {\n      padding: 25px;\n      border: 1px solid cyan;\n    }\n  "])));
    __decorate([
